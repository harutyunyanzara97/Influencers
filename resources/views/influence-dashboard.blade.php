...
<div class="d-flex ava-new">
    <div id="left-sidebar-fix" class="left-sidebar-fix">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link text-left d-none account-profile profile-tab" id="account-profile-tab" data-toggle="pill"  role="tab" aria-controls="account-profile" aria-selected="false">Account profile</a>
            ...
            <a class="nav-link  d-block" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><div class="d-flex"><span class="icon-teamwork-1" style="margin-left:10px"></span><p style="margin-left:10px">Campaigns</p></div></a>
            <a class="nav-link searchAdverticer d-block active" style="margin-left:10px;"><div class="d-flex"><span class="icon-Group"></span><p style="margin-left:10px">Search</p></div></a>
            <a class="nav-link d-block" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><div class="d-flex"><span class="icon-Vector" style="margin-left:10px"></span>
                    <p style="margin-left:10px">Bookmarks</p></div></a>
            <a class="nav-link d-block" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false"><div class="d-flex"><span class="icon-file-1" style="margin-left:10px"></span><p style="margin-left:10px">Campaign Report</p></div></a>
        </div>
    </div>
</div>
...
{{-- Dashboard Invites --}}
<div class="main-content" id="main" style="display:block">
...
<script>
    ...
    $(document).ready(function () {
        $('.open-tab').click(function () {
            ...
            // var b=document.getElementsByClassName("open-tab");
