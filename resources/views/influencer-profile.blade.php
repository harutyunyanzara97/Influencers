    ...
    <div class="max-w--933 mb-5 p-4">
        ...
        <form action="{{url('/storeProfile')}}" method="post" class="pt-2"
            ...
            <div class="text-center">
                <div class="prof-img-area m-0--auto" style="top: 100%;
                        left: 0;
                        width: 100%;
                        height: 100%;
                        text-align: center;
                    ...
                    <div class="abs d-flex justify-content-center" style="position: static !important;">
                            <input id="upload" type='file' name="photo[]" onchange="readURL(this);" />
                            <label id="upload-label" for="upload" class="h--50 fs-14-black text-left text-muted" style="    margin-top: -36px;
                                        position: absolute;
                                        margin-left: 65%;
                                        /* top: -47%; */
                                        left: -9rem;">
            ...
            <div>
                <div class="roboto-16 px-5 py-3 ml-4">Select topic</div>
                <div>
