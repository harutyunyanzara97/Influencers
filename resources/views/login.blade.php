...
<main class="">
    <div class="d-flex align-items-center flex-wrap">
        ...
        <div class="flex-1 px-140">
            ...
            <form method="POST" action="{{ route('dashboard') }}" class="pt-2">
                @csrf
                ...
                <div class="d-flex justify-content-between py-4">
                    <p class="fs-18-gray">Don't have an account yet? <a href="{{url('/register-influencer')}}" class="color-red">Sign Up </a></p>
