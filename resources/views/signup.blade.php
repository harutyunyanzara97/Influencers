...
<main class="">
    <div class="d-flex align-items-center">
        ...
        <div class="flex-1 px-140">
            <h2 class="fs-24-bold-black mb-5">Register to become a member of Influencer Union's professional advertising network  and earn money by building partnerships with brands and businesses.  </h2>
            <form action="{{ route('registerInf') }}" method="post" class="pt-2">
                @csrf
...
{{--                        @endif--}}
{{--                        <label for="lastName" class="fs-14-gray">Last Name</label>--}}
{{--                        <input type="text" class="form-control pr-input" name="last_name" id="lastName" placeholder="Last Name">--}}
{{--                    </div>--}}
...
{{--                    <input type="number" class="form-control pr-input p-l--80" name="phone" id="phone" placeholder="Phone">--}}
{{--                </div>--}}
{{--                <div class="form-group">--}}
{{--                    <label for="Password" class="fs-14-gray">Password</label>--}}
