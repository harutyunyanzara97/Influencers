...
{{--                        <a class="form-control h--60 fs-14-black text-left" href="{{route('statisticsCampaign',$campaign->id)}}">{{$campaign->title}}</a>--}}
{{--                    <div class="position-absolute r-35-b-14">--}}
{{--                        <div class="d-flex align-items-center">--}}
{{--                            <div class="mr-5 ">1 influencer </div>--}}
{{--                            <a href="{{route('delCampaign',$campaign->id)}}" id="ststis_a"><i class="fa fa-times"></i></a>--}}

{{--                            <a href="{{route('statisticsCampaign',$campaign->id)}}" id="ststis_a"  class="ml-4"><img src="img/circle-next-icon.png" alt="" class="pointer"></a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    @endforeach--}}
{{--                </div>--}}
...
<div class="d-flex" style="max-width: 1600px; margin: 0 auto; position: relative">
    ...
    <div class="main-content">
        <div class="content-header p-10-35">
            <div class="d-flex justify-content-end">
                ...
                <div class="input-group m-0 header-input-section" style="">
                    <input type="text" class="form-control m-0 search" data-href="{{route('search')}}" name="search" placeholder="Search & find your category" aria-label="Search & find your category" aria-describedby="button-addon2">
                    <div class="input-group-append">
                        <button class="" type="button" id="button-addon2"><img src="{{asset('img/search-settings.png')}}" alt=""></button>
                    </div>
                    <div id="menu-view" class="d-none"> <button class="btn-header bg-transparent ml-4"><img src="{{asset('img/view.png')}}" alt="" class="mr-2">View</button></div>
        ...
        <div class="border-top"></div>
        <div class="content-page">
            <table class="table campaignTable">
                <thead>
                <tr>
                ...
                @if($campaigns)
                    @foreach($campaigns as $campaign)
                        <tr>
                            <th scope="row"><span><a href="{{route('statisticsCampaign',$campaign->id)}}">{{$campaign->title}}</a></span></th>
                            ...
                            <td class="dashboard-number">{{$campaign->per_post_rate}}</td>
                            <td class="post-details" style="width:20%"><p class="data-details">{{$campaign->start_date}}</p><p class="time-details">{{$campaign->end_date}}</p></td>

                            <td class="dashboard-point"><div class="point p-online"></div>Started</td>
                            <a href="{{route('statisticsCampaign',$campaign->id)}}" id="ststis_a" style="position: absolute;
                        right: 0;
                        top: 114px;">
                                <img src="img/circle-next-icon.png" alt="" class="pointer"></a>
                        </tr>
                    @endforeach
                @endif
...
<script>
    ...
    {{--                    let img=i.images;--}}
    {{--                    $('.campaignTable tbody').append(` <tr>--}}
    {{--                        <th scope="row"><span><a>${i.title}</a></span></th>--}}
    {{--                        <td class="product-image"><img src='{{asset("img")}}/${img}' alt="" width="200px"></td>--}}
    {{--                        <td class="product-description">${i.details}</td>--}}
    {{--                        <td class="product-description">{{$campaign->category->name}}</td>--}}
    {{--                        <td class="product-description">${i.hashtags}</td>--}}
    {{--                        <td class="dashboard-number">${i.per_post_rate}</td>--}}
    {{--                        <td class="post-details" style="width:20%"><p class="data-details">{{$campaign->start_date}}</p><p class="time-details">{{$campaign->end_date}}</p></td>--}}


    {{--                        <td class="dashboard-point"><div class="point p-online"></div>Started</td>--}}
    {{--                         <a  id="ststis_a" style="position: absolute;--}}
    {{--                        right: 0;--}}
    {{--                        top: 114px;">--}}
    {{--                            <img src="img/circle-next-icon.png" alt="" class="pointer"></a>--}}
    {{--                    </tr>`)--}}
